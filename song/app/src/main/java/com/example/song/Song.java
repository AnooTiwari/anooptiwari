...
public class Song  {
    public static void main(String[] args)
    {
      ...
      mapArtist.put(Artist,i);
        ...
        song1.setDuration(	"4:45");
        song1.setTitle("Kabhi Kabhie Mere Dil Mein");
        song1.setYear("1976");
        song1.setAlbum("Kabhi Kabhie");
        song1.setArtist("Mukesh");
        list.add(song1);
        mapTitle.put("Kabhi Kabhie Mere Dil Mein",1);
        mapAlbum.put("Kabhi Kabhie",1);
        mapArtist.put("Mukesh",1);
        ...
        {
            System.out.println("===========================================================================================================");
            System.out.println("Press 1 View a list of all the songs \nPress 2 list of all the artists in the library.");
            ...
            switch(choice)
            {
                ...
                case 9:/*Add songs to and remove them from albums*/
                {
                    ...
                    if(Choice_song.equalsIgnoreCase("A"))
                    {
                        ...
                        list.add(song_add2);
                        mapAlbum.put(Album,3);
                        mapArtist.put(Artist,3);
                    }else if(Choice_song.equalsIgnoreCase("R"))
                    {
                        System.out.println("\t\t\t\t\t**** Song Deletion Menu****");
                        String Song_delete;int search_delete_result;
