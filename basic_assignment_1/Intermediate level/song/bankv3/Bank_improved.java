	...
	public void newEntry()
	{
		...
		if(permit = true)   //Allows to create new entry
		{
			...
			try{
				...
				do{
					System.out.print("Enter Initial  Amount Min 10000 to be deposited : ");
					System.out.flush();
					str=obj.readLine();
			...
			public void deposit()
			{
				...
				try{
					...
					if (valid==true)
					{
						...
						balAmt[acno]=balAmt[acno]+amt;//amount add
				...
				class Sav_acct        //SAVING ACCOUNT CLASS
				{
					...
					public void newEntry()
					{
						...
						if(permit = true)   //Allows to create new entry
						{
							...
							System.out.println("\n\n\n=====RECORDING NEW ENTRY=====");
							try{
								accNo[totRec]=totRec;    //Created  AutoNumber  to accNo
								System.out.println("Account Number :  "+accNo[totRec]);
								...
								do{
									System.out.print("Enter Initial  Amount main Min 500 to be deposited : ");
									System.out.flush();
									str=obj.readLine();
									balAmt[totRec]=Double.parseDouble(str);
								}while(balAmt[totRec]<min_bal);      //Validation that minimun amount must be 500
						...
						public void display()
						{
							...
							public void deposit()
							{
								...
								class  Bank_improved
								{
									...
									{
										String str;
										int choice,Check_acc_type=1,quit=0;
										choice=0;

										Curr_acct curr_obj = new Curr_acct();
										Sav_acct sav_obj = new Sav_acct();

										System.out.println("\n=====WELLCOME TO  SECURIFI BANK PROJECT=====\n");
										...
										while( quit!=1)
										{
											try{
												...
												System.out.flush();
												str=obj.readLine();//reading the userr choice
												Check_acc_type=Integer.parseInt(str);
											}
											catch(Exception e) {}
