...
HashMap <String,String> hm =new HashMap<>();
  ...
  <n;i++)
          ...
          hm.put("Bahadur","9984183098");
          hm.put("Bahadur","999999999");
          ...
          String returned_value = (String)hm.put(detail,"All");
          System.out.println("****Match found**** But Given String is Not a KEY It is a VALUE  ");
          for (Map.Entry
          <String,String> entry : hm .entrySet()){
  if( entry.getValue().equals(detail))
  System.out.println("Given Value match with  Key = ****" + entry.getKey()+"****");
  }}
  else{
